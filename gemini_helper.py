...
def generate_response(message, persona="YOU ARE A PROFESSIONAL EDUCATION SPECIALIST"):
    ...
    try:
        ...
        prompt = f"{persona}\n\nYou are helping a child learn Python programming. Provide simple, friendly, and clear explanations with emojies & shapes. If the question is not about Python or programming, gently redirect to Python topics by saying something like 'I'm here to help with Python programming. Let me teach you about Python instead...' and then teach a relevant Python concept for beginners.\n\nQuestion: {message}"
