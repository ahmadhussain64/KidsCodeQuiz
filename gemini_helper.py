...
def get_fallback_response(message):
    ...
    fallback_responses = {
        ...
        "fallback53": "I need to `import help`! Could you clarify your Python question about functions or basics?",
        ...
        "fallback187": "My Python’s glowing! Try: `for i in [1, 2]: print(\"Yay!\")`. What Python trick do you want?",
        ...
        "fallback196": "I think my Python’s ready! Try: `ifHa x == 10: print(\"Ten!\")`. Can you ask about conditions?",
    ...
    # Return the response if the message matches a key, otherwise return a default response
    return fallback_responses.get(message.lower(), "I’m not sure what you mean! Try asking about Python basics like variables, loops, or functions. For example, type 'variables' or 'print' to learn more!")
